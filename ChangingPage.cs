...
namespace UserData
{
    class ChangingPage : INotifyPropertyChanged
    {
        ...
        public string[] Visible { get; set; } = new string[countitems];//Массив свойств, отвечающий за видимость объекта Visible - видимый, Hidden - скрытый
        public string[] Selected { get; set; } = new string[countitems];//массив свойств, отвечающий за выделение текущей страницы
        int countpages;
        ...
        public int CountPage  //количество на странице
        {
            ...
            set
            {
                ...
                else CountPages = 1 + Countlist / value;//если получается не целое количество страниц
            }
        }
        ...
        public int CurrentPage
        {
            ...
            set
            {
                ...
                {
                    if (NPage[i] == currentpage) Selected[i] = "ExtraBold";
                    else Selected[i] = "Regular";
                }
